...
readonly REPO_URL="https://github.com/erffy-dots/nvim.git"
...
echo "Downloading Nvim configuration files from GitHub..."

# Handle existing configuration
if [ -d "$CONFIG_DIR" ]; then
    echo "Existing Nvim configuration detected at '$CONFIG_DIR'."
...
echo "You may need to install additional dependencies for Nvim."
echo "Refer to the Nvim documentation for more information."
